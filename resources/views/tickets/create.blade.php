...
<section class="py-16 bg-gray-50 text-center">
    <div class="max-w-6xl mx-auto px-4">
        <h1 class="text-4xl font-bold mb-6 text-blue-600">Tickets & Booking</h1>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
            ...
            @foreach($tickets as $ticket)
                <div class="bg-white shadow-lg rounded-2xl p-6 flex flex-col">
                    ...
                    <a href="#booking-form" class="mt-auto px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                        Book Now
                    </a>
                </div>
            @endforeach
...
<section class="py-16 bg-white">
    <div class="max-w-xl mx-auto px-4" id="booking-form">
        <h2 class="text-2xl font-bold mb-4 text-blue-600 text-center">Book Your Ticket</h2>
